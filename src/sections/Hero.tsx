...
const defaultPointer: PointerState = { x: 50, y: 34, active: false };
...
export default function Hero({ isIntroReady = true, onNavigate }: HeroProps) {
  ...
  useEffect(() => {
    ...
    if (prefersReducedMotion || !heroRef.current || !heroContentRef.current) {
      return undefined;
    }

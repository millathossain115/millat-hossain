...
interface UseEducationAnimationsProps {
  sectionRef: RefObject<HTMLElement | null>;
  cinemaViewportRef: RefObject<HTMLDivElement | null>;
  zoomTextRef: RefObject<HTMLDivElement | null>;
  redCurtainRef: RefObject<HTMLDivElement | null>;
  recordScreenRef: RefObject<HTMLDivElement | null>;
  recordHeadingRef: RefObject<HTMLDivElement | null>;
...
export default function useEducationAnimations({
  ...
  useEffect(() => {
    ...
    let removeExperienceIntro: (() => void) | undefined;
    ...
    const ctx = gsap.context(() => {
      ...
      const zoomTitle =
        zoomTextRef.current!.querySelector<HTMLElement>('.edu-zoom-title') ??
        zoomTextRef.current!;

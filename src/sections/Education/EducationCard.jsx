...
export default function EducationCard({ edu, Icon }) {
  return (
    <div className="edu-item relative pl-7 sm:pl-10">
      ...
      <div className="edu-content relative overflow-hidden rounded-xl border border-white/[0.09] bg-black shadow-[inset_0_1px_0_rgba(255,255,255,0.035),0_18px_48px_rgba(0,0,0,0.2)] transition-[border-color,background-color,box-shadow,transform] duration-300">
        ...
        <div className="pointer-events-none absolute -right-20 -top-24 h-48 w-48 rounded-full bg-[#DC143C]/[0.06] blur-3xl transition-opacity duration-300" />
        ...
        <div className="relative p-4 sm:p-5">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between md:gap-6">
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0">
                <h3 className="font-display text-base font-semibold uppercase leading-tight tracking-[0.035em] text-slate-100 transition-colors duration-300 sm:text-lg">
                  {edu.degree}
                </h3>
                <p className="mt-1 text-xs font-semibold uppercase tracking-[0.055em] text-[#DC143C] transition-colors duration-300 sm:text-sm">
                  {edu.institution}
                </p>
              </div>
            </div>
          ...
          {edu.achivement && (
            <p className="mt-3 flex items-start gap-2 border-t border-white/[0.07] pt-3 text-xs italic leading-5 text-slate-400 transition-colors duration-300 sm:ml-10">
              <FaAward
                aria-hidden="true"
